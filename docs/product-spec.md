...
categoria** (escritório, passagens, combustível, divulgação…) e o maior fornecedor — **informativo**:
...
5. **Nenhuma penalidade externa entra no Poder — e o Karma saiu por isso.** O *Karma Pesado*
   ...
   outros atributos (ver a âncora na mediana, em CLAUDE.md). Somou-se a isso que contas
